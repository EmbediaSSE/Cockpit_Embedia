...
CREATE TABLE public.projects (
  ...
  stage TEXT NOT NULL CHECK (stage IN ('Won', 'Active', 'Planned', 'Concept', 'Backlog')),
  status TEXT NOT NULL DEFAULT 'active' CHECK (status IN ('active', 'pending', 'on_hold', 'completed')),
